...
namespace Intranet.Controllers
{
    public class ONasController : Controller
    {
        ...
        public ONasController(DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdONas,Tytul,Opis,Grafika")] ONas oNas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdONas,Tytul,Opis,Grafika")] ONas oNas)
        {
            if (id != oNas.IdONas)
            {
                return NotFound();
